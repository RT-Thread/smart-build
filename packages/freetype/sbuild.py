#!/usr/bin/env python3
"""Build FreeType from its public release archive."""
...
def main() -> int:
    ...
    copy_tree(dest_dir / "usr/include/freetype2", stage_dir / "usr/include/freetype2")
    copy_file(dest_dir / "usr/lib/libfreetype.a", stage_dir / "usr/lib/libfreetype.a", 0o644)
    return 0
