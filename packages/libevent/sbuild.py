#!/usr/bin/env python3
"""Build static libevent without optional TLS providers."""
...
def main() -> int:
    ...
    copy_tree(dest_dir / "usr/include/event2", stage_dir / "usr/include/event2")
    for name in ("libevent.a", "libevent_core.a", "libevent_extra.a"):
        copy_file(dest_dir / "usr/lib" / name, stage_dir / "usr/lib" / name, 0o644)
    return 0
