#!/usr/bin/env python3
"""Build PCRE2 as a static Smart package."""
...
def main() -> int:
    ...
    copy_file(dest_dir / "usr/include/pcre2.h", stage_dir / "usr/include/pcre2.h", 0o644)
    copy_file(dest_dir / "usr/lib/libpcre2-8.a", stage_dir / "usr/lib/libpcre2-8.a", 0o644)
    return 0
