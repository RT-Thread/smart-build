#!/usr/bin/env python3
"""Build libpng as a static Smart package."""
...
def main() -> int:
    ...
    zlib_dir = dependency_root() / "zlib"
    env = os.environ.copy()
    append_env_flags(env, "CPPFLAGS", "-I" + str(zlib_dir / "include"))
    append_env_flags(env, "LDFLAGS", "-L" + str(zlib_dir / "lib"))
    ...
    copy_file(dest_dir / "usr/include/png.h", stage_dir / "usr/include/png.h", 0o644)
    copy_file(dest_dir / "usr/lib/libpng16.a", stage_dir / "usr/lib/libpng16.a", 0o644)
    return 0
